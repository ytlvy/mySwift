...
@interface YLPNeon_View (YLPGroupable)
 ...
 *  @param sibling      The sibling view that the views will be aligned relative to.
 *  @param padding      The padding to be applied between each of the subviews and the sibling.
 *  @param maxWidth     The maxWidth of YLPGroupVertical each subview.
 *  @param maxHeight    The maxHeight of YLPGroupHorizontal each subview.
 */
- (void)groupAndAlign:(YLPGroup)group
             andAlign:(YLPAlign)align
                viwes:(NSArray *)views
